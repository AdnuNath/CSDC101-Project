                         ...
                         int totalRows)
{
    ...
    // One engine seeded once — reusing time(nullptr) inside the loop gives
    // every row the same seed (all rows run in under a second).
